...
hadoop jar /usr/lib/hadoop-mapreduce/hadoop-streaming.jar \
    ...
    -files $HOME/sandbox/hadoop/streaming/map/countMapper.py,$HOME/sandbox/hadoop/streaming/reduce/nReduce.py,$HOME/sandbox/hadoop/streaming/data/keywords.txt \
    -input bztest \
    -output output \
    -mapper "countMapper.py -k keywords.txt -d hour" \
