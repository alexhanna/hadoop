...
hadoop jar /usr/lib/hadoop-mapreduce/hadoop-streaming.jar \
    ...
    -files $HOME/sandbox/hadoop/streaming/map/countMapper.py,$HOME/sandbox/hadoop/streaming/reduce/nReduce.py,$HOME/sandbox/hadoop/streaming/data/keywords.txt,$HOME/sandbox/hadoop/streaming/data/follow-r3.txt \
    -input elextest \
    -output output \
    -mapper "countMapper.py -d hour" \
